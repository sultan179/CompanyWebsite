...
const Products = () => {
  ...
  const workInfoData = [
    {
      video: process.env.PUBLIC_URL + "/Products/fabricationVideo.mp4",
      title: "Fabrication",
    ...
    {
      video: process.env.PUBLIC_URL + "/Products/equipmentSupply.mp4",
    ...
    {
      video: process.env.PUBLIC_URL + "/Products/skids.mp4",
